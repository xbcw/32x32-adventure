...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Brad Williams", "Main2", "net.xbcw.lowrezjam", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "LowRezJam Metroidvania", null, { width: 32, height: 32 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 32, height: 32 });
			#end
