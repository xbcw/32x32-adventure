...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("graphics/caveparallax.png", __ASSET__graphics_caveparallax_png);
		type.set ("graphics/caveparallax.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		className.set ("graphics/visibonepallet.png", __ASSET__graphics_visibonepallet_png);
		type.set ("graphics/visibonepallet.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("font/04B_03__.ttf", __ASSET__font_5);
		type.set ("font/04B_03__.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
		className.set ("maps/testCave.tmx", __ASSET__maps_testcave_tmx);
		type.set ("maps/testCave.tmx", Reflect.field (AssetType, "binary".toUpperCase ()));
		...
		addExternal("graphics/caveparallax.png", "image", "graphics/caveparallax.png");
		addExternal("graphics/player.png", "image", "graphics/player.png");
		addExternal("graphics/visibonepallet.png", "image", "graphics/visibonepallet.png");
		addEmbed("font/04B_03__.ttf", "font", __ASSET__font_5);
		addExternal("maps/testCave.tmx", "binary", "maps/testCave.tmx");
...
class __ASSET__graphics_caveparallax_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__graphics_player_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__graphics_visibonepallet_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__font_5 extends flash.text.Font { }
class __ASSET__maps_testcave_tmx extends flash.utils.ByteArray { }
